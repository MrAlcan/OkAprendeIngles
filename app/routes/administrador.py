...
@administrador_bp.route('/sesiones/dia/siguiente', methods = ['GET'])
@token_requerido
...
@administrador_bp.route('/sesiones/dia/subsiguiente', methods = ['GET'])
@token_requerido
...
@administrador_bp.route('/material', methods=['GET'])
@token_requerido
